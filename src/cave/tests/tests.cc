...
class CaveTest : public testing::Test {
 public:
    void file_test(std::string test_file, int birth_limit_, int death_limit_, std::string expected_file) {
...
TEST_F(CaveTest, generator_1) {
  generator_test(1000, 1000, 0.75);
}

TEST_F(CaveTest, generator_2) {
  generator_test(4323, 357, 0.25);
}

TEST_F(CaveTest, generator_3) {
  generator_test(12, 123, 0.37);
}
